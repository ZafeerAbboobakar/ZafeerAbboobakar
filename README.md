...
Currently exploring how to build secure, scalable systems while experimenting with automation and data-driven apps.
...
![Nmap](https://img.shields.io/badge/Nmap-004660?style=flat&logo=linux&logoColor=white)
![Wireshark](https://img.shields.io/badge/Wireshark-1679B2?style=flat&logo=wireshark&logoColor=white)
...
- 🚀 Automate an entire business ecosystem 
- 🧪 Build & deploy secure web apps from scratch
- 🎓 Complete certifications IT 
- 🌐 Contribute to open-source IT tools
